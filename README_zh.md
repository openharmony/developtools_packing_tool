...
```
java -jar app_packing_tool.jar --mode hqf --json-path <option> --lib-path <option> --ets-path <option> --res-path <option> --out-path <option>
```
...
| --res-path  | 否     | NA          | resfile资源文件的路径，打包后在包中的路径为resources/resfile/ |
