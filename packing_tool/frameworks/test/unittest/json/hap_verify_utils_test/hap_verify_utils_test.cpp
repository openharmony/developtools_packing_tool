 ...
 * @tc.desc: CheckProxyDataUriIsUnique with empty list and duplicate URIs in same module
 * @tc.type: FUNC
 ...
 * @tc.desc: Test different modules with same URI in same deviceType returns false (patch_1439)
 * @tc.type: FUNC
 * @tc.require: patch_1439_duplicate_uri_cross_modules_same_devicetype
 */
HWTEST_F(HapVerifyUtilsTest, CheckProxyDataUriIsUnique_0200, Function | MediumTest | Level1)
{
    OHOS::AppPackingTool::HapVerifyUtils utils;
    std::list<OHOS::AppPackingTool::HapVerifyInfo> hapVerifyInfos;
    ...
    // Same URI in same deviceType across different modules should return false
    EXPECT_FALSE(utils.CheckProxyDataUriIsUnique(hapVerifyInfos));
}

/*
 * @tc.name: CheckProxyDataUriIsUnique_0300
 * @tc.desc: Test different modules with same URI in different deviceTypes returns true (patch_1439)
 * @tc.type: FUNC
 * @tc.require: patch_1439_same_uri_different_devicetype
 */
HWTEST_F(HapVerifyUtilsTest, CheckProxyDataUriIsUnique_0300, Function | MediumTest | Level1)
{
    OHOS::AppPackingTool::HapVerifyUtils utils;
    std::list<OHOS::AppPackingTool::HapVerifyInfo> hapVerifyInfos;
    ...
    // Same URI in different deviceTypes should return true
    EXPECT_TRUE(utils.CheckProxyDataUriIsUnique(hapVerifyInfos));
}

/*
 * @tc.name: CheckProxyDataUriIsUnique_0400
 * @tc.desc: Test module with empty URIs is skipped (patch_1439)
 * @tc.type: FUNC
 * @tc.require: patch_1439_skip_empty_uris
 */
HWTEST_F(HapVerifyUtilsTest, CheckProxyDataUriIsUnique_0400, Function | MediumTest | Level1)
{
    OHOS::AppPackingTool::HapVerifyUtils utils;
    std::list<OHOS::AppPackingTool::HapVerifyInfo> hapVerifyInfos;
    ...
    std::list<std::string> deviceTypes1 = {"phone"};
    info1.SetDeviceTypes(deviceTypes1);
    std::list<std::string> uris1 = {};  // Empty URIs
    info1.SetProxyDataUris(uris1);
    ...
    // Module with empty URIs should be skipped, validation should pass
    EXPECT_TRUE(utils.CheckProxyDataUriIsUnique(hapVerifyInfos));
}

/*
 * @tc.name: CheckProxyDataUriIsUnique_0500
 * @tc.desc: Test module with empty deviceTypes uses NULL_DEVICE_TYPE (patch_1439)
 * @tc.type: FUNC
 * @tc.require: patch_1439_null_devicetype_handling
 */
HWTEST_F(HapVerifyUtilsTest, CheckProxyDataUriIsUnique_0500, Function | MediumTest | Level1)
{
    OHOS::AppPackingTool::HapVerifyUtils utils;
    std::list<OHOS::AppPackingTool::HapVerifyInfo> hapVerifyInfos;
    ...
    OHOS::AppPackingTool::HapVerifyInfo info1;
    info1.SetModuleName("moduleA");
    std::list<std::string> deviceTypes1 = {};  // Empty deviceTypes
    info1.SetDeviceTypes(deviceTypes1);
    std::list<std::string> uris1 = {"uri://service1"};
    info1.SetProxyDataUris(uris1);
    ...
    OHOS::AppPackingTool::HapVerifyInfo info2;
    info2.SetModuleName("moduleB");
    std::list<std::string> deviceTypes2 = {};  // Empty deviceTypes
    info2.SetDeviceTypes(deviceTypes2);
    std::list<std::string> uris2 = {"uri://service1"};
    info2.SetProxyDataUris(uris2);
    ...
    // Both modules with empty deviceTypes should use NULL_DEVICE_TYPE, duplicate URI should fail
    EXPECT_FALSE(utils.CheckProxyDataUriIsUnique(hapVerifyInfos));
}

/*
 * @tc.name: CheckProxyDataUriIsUnique_0600
 * @tc.desc: Test module without deviceType conflicts with module with deviceType (patch_1439)
 * @tc.type: FUNC
 * @tc.require: patch_1439_null_devicetype_vs_devicetype_conflict
 */
HWTEST_F(HapVerifyUtilsTest, CheckProxyDataUriIsUnique_0600, Function | MediumTest | Level1)
{
    OHOS::AppPackingTool::HapVerifyUtils utils;
    std::list<OHOS::AppPackingTool::HapVerifyInfo> hapVerifyInfos;
    ...
    OHOS::AppPackingTool::HapVerifyInfo info1;
    info1.SetModuleName("moduleA");
    std::list<std::string> deviceTypes1 = {};  // No deviceType
    info1.SetDeviceTypes(deviceTypes1);
    std::list<std::string> uris1 = {"uri://service1"};
    info1.SetProxyDataUris(uris1);
    ...
    // NULL_DEVICE_TYPE conflicts with "phone" deviceType
    EXPECT_FALSE(utils.CheckProxyDataUriIsUnique(hapVerifyInfos));
}
 ...
 */
HWTEST_F(HapVerifyUtilsTest, CheckProxyDataUriIsUnique_0700, Function | MediumTest | Level1)
{
    OHOS::AppPackingTool::HapVerifyUtils utils;
    std::list<OHOS::AppPackingTool::HapVerifyInfo> hapVerifyInfos;
    ...
    // Different URIs in same deviceType should return true
    EXPECT_TRUE(utils.CheckProxyDataUriIsUnique(hapVerifyInfos));
}
 ...
 */
HWTEST_F(HapVerifyUtilsTest, CheckProxyDataUriIsUnique_0800, Function | MediumTest | Level1)
{
    OHOS::AppPackingTool::HapVerifyUtils utils;
    std::list<OHOS::AppPackingTool::HapVerifyInfo> hapVerifyInfos;
    ...
    // Complex scenario: different URIs per deviceType, no duplicates
    EXPECT_TRUE(utils.CheckProxyDataUriIsUnique(hapVerifyInfos));
}

/*
 * @tc.name: CheckProxyDataUriIsUnique_0900
 * @tc.desc: Test module with multiple URIs where one is duplicate across modules in same deviceType
 * @tc.type: FUNC
 * @tc.require: patch_1439_partial_duplicate
 */
HWTEST_F(HapVerifyUtilsTest, CheckProxyDataUriIsUnique_0900, Function | MediumTest | Level1)
{
    OHOS::AppPackingTool::HapVerifyUtils utils;
    std::list<OHOS::AppPackingTool::HapVerifyInfo> hapVerifyInfos;
    ...
    // One duplicate URI (uri://service2) in same deviceType should return false
    EXPECT_FALSE(utils.CheckProxyDataUriIsUnique(hapVerifyInfos));
}
 ...
 */
HWTEST_F(HapVerifyUtilsTest, CheckProxyDataUriIsUnique_1000, Function | MediumTest | Level1)
{
    OHOS::AppPackingTool::HapVerifyUtils utils;
    std::list<OHOS::AppPackingTool::HapVerifyInfo> hapVerifyInfos;
    ...
    // All modules with empty URIs should return true (all skipped)
    EXPECT_TRUE(utils.CheckProxyDataUriIsUnique(hapVerifyInfos));
}
