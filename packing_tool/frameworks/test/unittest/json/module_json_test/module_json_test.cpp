...
const std::string MODULE_ABILITY_NAME_EMPTY_TEST_JSON_STRING = "{"
    "\"app\": {"
        "\"bundleType\": \"atomicService\""
    "},"
    "\"module\": {"
...
const std::string APP_SHARE_BUNDLE_TYPE_TEST_JSON_STRING = "{"
    "\"app\": {"
        "\"bundleType\": \"shared\""
    "},"
    "\"module\": {"
...
const std::string INSTALLATION_FREE_TEST_JSON_STRING = "{"
    "\"app\": {"
        "\"bundleType\": \"atomicService\""
    "},"
    "\"module\": {"
...
const std::string MODULE_NAME_ERROR_TEST_JSON_STRING = "{"
    "\"app\": {"
        "\"version\": {"
            "\"code\": 666,"
            "\"name\": \"test_version\","
...
const std::string APP_BUNDLE_NAME_ERROR_TEST_JSON_STRING = "{"
    "\"app\": {"
        "\"bundleName\":  ["
        "],"
...
const std::string APP_VENDOR_ERROR_TEST_JSON_STRING = "{"
    "\"app\": {"
        "\"vendor\":  ["
        "]"
    "}"
...
const std::string APP_TARGET_BUNDLE_NAME_ERROR_TEST_JSON_STRING = "{"
    "\"app\": {"
        "\"targetBundleName\":  ["
        "]"
    "},"
...
const std::string MODULE_TARGET_MODULE_NAME_ERROR_TEST_JSON_STRING = "{"
    "\"module\": {"
        "\"targetModuleName\":  ["
        "]"
    "}"
...
const std::string MODULE_METADATA_NAME_ERROR_TEST_JSON_STRING = "{"
    "\"module\": {"
        "\"metadata\": ["
            "{"
                "\"name\":  ["
...
const std::string MODULE_METADATA_VALUE_ERROR_TEST_JSON_STRING = "{"
    "\"module\": {"
        "\"metadata\": ["
            "{"
                "\"name\": \"test_metadata\","
...
const std::string MODULE_METADATA_RESOURCE_ERROR_TEST_JSON_STRING = "{"
    "\"module\": {"
        "\"metadata\": ["
            "{"
                "\"name\": \"test_metadata\","
...
const std::string MODULE_PROXY_URI_ERROR_TEST_JSON_STRING = "{"
    "\"module\": {"
        "\"proxyData\": ["
            "{"
                "\"uri\":  ["
...
const std::string MODULE_EXTENSION_ABILITIES_NAME_ERROR_TEST_JSON_STRING = "{"
    "\"module\": {"
        "\"extensionAbilities\": ["
            "{"
                "\"name\":  ["
...
const std::string MODULE_DEPENDENCIES_BUNDLE_NAME_ERROR_TEST_JSON_STRING = "{"
    "\"module\": {"
        "\"dependencies\": ["
            "{"
                "\"bundleName\":  ["
...
const std::string MODULE_DEPENDENCIES_MODULE_NAME_ERROR_TEST_JSON_STRING = "{"
    "\"module\": {"
        "\"dependencies\": ["
            "{"
                "\"bundleName\": \"test_modules_dependency\","
                "\"moduleName\":  ["
                "]"
            "}"
        "]"
...
const std::string MODULE_ATOMIC_SERVICE_PRELOADS_MODULE_NAME_ERROR_TEST_JSON_STRING = "{"
    "\"module\": {"
        "\"atomicService\": {"
            "\"preloads\": ["
                "{"
...
const std::string MODULE_ABILITIES_NAME_ERROR_TEST_JSON_STRING = "{"
    "\"module\": {"
        "\"abilities\": ["
            "{"
                "\"name\":  ["
...
const std::string MODULE_ABILITIES_CONTINUE_TYPE_ERROR_TEST_JSON_STRING = "{"
    "\"module\": {"
        "\"abilities\": ["
            "{"
                "\"name\": \"EntryAbility\","
...
const std::string APP_MULTI_APP_MODE_TYPE_ERROR_TEST_JSON_STRING = "{"
    "\"app\": {"
        "\"multiAppMode\": {"
            "\"multiAppModeType\":  ["
            "]"
...
const std::string APP_MULTI_APP_MODE_NUMBER_ERROR_TEST_JSON_STRING = "{"
    "\"app\": {"
        "\"multiAppMode\": {"
            "\"multiAppModeType\": \"test_multiAppMode\","
            "\"maxCount\":  ["
...
const std::string APP_BUNDLE_TYPE_ERROR_TEST_JSON_STRING = "{"
    "\"app\": {"
        "\"bundleType\":  ["
        "]"
    "}"
...
const std::string MODULE_REQUEST_PERMISSIONS_AND_TARGET_MODULE_NAME_ERROR_TEST_JSON_STRING = "{"
    "\"module\": {"
        "\"requestPermissions\": true,"
        "\"targetModuleName\": \"targetModuleName\""
    "}"
...
const std::string MODULE_TARGET_MODULE_NAME_AND_NAME_SAME_TEST_JSON_STRING = "{"
    "\"module\": {"
        "\"name\": \"test\","
...
const std::string MODULE_TARGET_MODULE_NAME_AND_TARGET_PRIORITY_ERROR_TEST_JSON_STRING = "{"
    "\"module\": {"
        "\"targetModuleName\": \"\","
        "\"targetPriority\": 6"
    "}"
...
const std::string APP_TARGET_BUNDLE_NAME_AND_TARGET_MODULE_NAME_ERROR_TEST_JSON_STRING = "{"
    "\"app\": {"
        "\"targetBundleName\": \"targetBundleName\""
    "},"
    "\"module\": {"
...
const std::string APP_TARGET_BUNDLE_NAME_AND_BUNDLE_NAME_ERROR_TEST_JSON_STRING = "{"
    "\"app\": {"
        "\"bundleName\": \"test\","
        "\"targetBundleName\": \"test\""
    "},"
    "\"module\": {"
        "\"name\": \"entry\","
        "\"targetModuleName\": \"targetModuleName\""
...
const std::string APP_TARGET_BUNDLE_NAME_AND_TARGET_PRIORITY_ERROR_TEST_JSON_STRING = "{"
    "\"app\": {"
        "\"targetBundleName\": \"\","
        "\"targetPriority\": 6"
    "},"
...
const std::string APP_GENERATE_BUILD_HASH_ERROR_TEST_JSON_STRING = "{"
    "\"app\": {"
        "\"generateBuildHash\":  ["
        "]"
    "}"
...
const std::string MODULE_GENERATE_BUILD_HASH_ERROR_TEST_JSON_STRING = "{"
    "\"module\": {"
        "\"generateBuildHash\":  ["
        "]"
    "}"
...
const std::string APP_AND_MODULE_EMPTY_TEST_JSON_STRING = "{"
    "\"app\": {"
    "},"
    "\"module\": {"
    "}"
...
const std::string MODULE_JSON_TEST_VERCODE_NOTINT_STRING = "{"
    "\"app\": {"
        "\"version\": {"
            "\"code\": \"ERROR_CODE\","
            "\"name\": \"test_version\","
...
const std::string MODULE_JSON_TEST_NOT_VERCODE_STRING = "{"
    "\"app\": {"
        "\"version\": {"
            "\"name\": \"test_version\","
            "\"minCompatibleVersionCode\": 555"
...
const std::string MODULE_JSON_TEST_NOTVERNAME_STRING = "{"
    "\"app\": {"
        "\"version\": {"
            "\"code\": 666,"
            "\"minCompatibleVersionCode\": 555"
...
const std::string MODULE_JSON_TEST_VERNAME_NOTSTRING_STRING = "{"
    "\"app\": {"
        "\"version\": {"
            "\"code\": 666,"
            "\"name\": {"
...
const std::string MODULE_JSON_TEST_VERMINCOMPATIBLEVERSIONCODE_NOTINT_STRING = "{"
    "\"app\": {"
        "\"version\": {"
            "\"code\": 666,"
            "\"name\": \"test_version\","
            "\"minCompatibleVersionCode\": \"ERROR_minCompatibleVersionCode\""
        "}"
    "}"
"}";

const std::string MODULE_JSON_TEST_DISINSTALLATIONFREE_NOTBOOL_STRING = "{"
    "\"module\": {"
        "\"distro\": {"
            "\"installationFree\": \"ERROR_installationFree\","
            "\"moduleType\": \"entry\","
            "\"moduleName\": \"test_module_name\""
        "}"
    "}"
...
const std::string MODULE_JSON_TEST_DISINSTALLATIONFREE_ISTRUE_STRING = "{"
    "\"module\": {"
        "\"distro\": {"
            "\"installationFree\": true,"
            "\"moduleType\": \"entry\","
...
const std::string MODULE_JSON_APICOMPATIBLE_NOTINT_STRING = "{"
    "\"app\": {"
        "\"apiVersion\": {"
            "\"compileSdkType\": \"OpenHarmony\","
            "\"compileSdkVersion\": \"test_apiVersion_compileSdkVersion\","
            "\"releaseType\": \"test_apiVersion_release\","
            "\"compatible\": \"error_compatible\","
            "\"target\": 10"
        "}"
    "}"
"}";

const std::string MODULE_JSON_APITARGET_NOTINT_STRING = "{"
    "\"app\": {"
        "\"apiVersion\": {"
            "\"compileSdkType\": \"OpenHarmony\","
            "\"compileSdkVersion\": \"test_apiVersion_compileSdkVersion\","
...
const std::string MODULE_JSON_APIRELEASETYPE_NOTSTRING_STRING = "{"
    "\"app\": {"
        "\"apiVersion\": {"
            "\"compileSdkType\": \"OpenHarmony\","
            "\"compileSdkVersion\": \"test_apiVersion_compileSdkVersion\","
...
const std::string MODULE_JSON_EMPTY_APP_AND_MODULE_STRING = "{"
    "\"app\": {"
    "},"
    "\"module\": {"
    "}"
...
const std::string MODULE_JSON_NOT_DISMODULENAME_STRING = "{"
    "\"module\": {"
        "\"distro\": {"
            "\"installationFree\": true,"
            "\"moduleType\": \"entry\""
...
const std::string MODULE_JSON_DISMODULENAME_NOTSTRING_STRING = "{"
    "\"module\": {"
        "\"distro\": {"
            "\"installationFree\": true,"
            "\"moduleType\": \"entry\","
...
const std::string MODULE_JSON_MOUPACKAGE_NOTSTRING_STRING = "{"
    "\"module\": {"
        "\"package\": {"
            "\"error1\": \"error1\","
            "\"error2\": \"error2\""
...
const std::string MODULE_JSON_APICOMPILESDKTYPE_NOTSTRING_STRING = "{"
    "\"app\": {"
        "\"apiVersion\": {"
            "\"compileSdkType\": {"
                "\"error1\": \"error1\","
...
const std::string MODULE_JSON_APICOMPILESDKVERSION_NOTSTRING_STRING = "{"
    "\"app\": {"
        "\"apiVersion\": {"
            "\"compileSdkType\": \"OpenHarmony\","
            "\"compileSdkVersion\": {"
...
const std::string MODULE_JSON_DEVDEBUG_NOTBOOL_STRING = "{"
    "\"deviceConfig\": {"
        "\"default\": {\"debug\": \"error_default\"}"
    "}"
"}";

const std::string MODULE_JSON_TEST_NOT_DISMODULETYPE_STRING = "{"
    "\"module\": {"
        "\"distro\": {"
            "\"installationFree\": false,"
            "\"moduleName\": \"test_module_name\""
...
const std::string MODULE_JSON_TEST_DISMODULETYPE_NOTSTRING_STRING = "{"
    "\"module\": {"
        "\"distro\": {"
            "\"installationFree\": false,"
            "\"moduleType\": {"
...
const std::string MODULE_JSON_MODDEVICETYPE_NOTARRAY_STRING = "{"
    "\"module\": {"
        "\"deviceType\": {"
            "\"error1\": \"error1\","
            "\"error2\": \"error2\""
...
const std::string MODULE_JSON_APPASANENBALED_NOTBOOL_STRING = "{"
    "\"app\": {"
        "\"asanEnabled\": {"
            "\"error1\": \"error1\","
            "\"error2\": \"error2\""
...
const std::string DEVICE_CONFIG_NOT_OBJECT_TEST_JSON_STRING = "{"
    "\"deviceConfig\": \"test\""
"}";
...
const std::string MODULE_NOT_OBJECT_TEST_JSON_STRING = "{"
    "\"module\": \"test\""
"}";

const std::string MODULE_DISTRO_NOT_OBJECT_TEST_JSON_STRING = "{"
    "\"module\": {"
        "\"distro\": \"test\""
    "}"
"}";

const std::string APP_API_VERSION_NOT_OBJECT_TEST_JSON_STRING = "{"
    "\"app\": {"
        "\"apiVersion\": \"test\""
    "}"
"}";

const std::string APP_TARGET_PRIORITY_NOT_INT_TEST_JSON_STRING = "{"
    "\"app\": {"
        "\"targetPriority\": {"
        "}"
    "}"
...
const std::string MODULE_TARGET_PRIORITY_NOT_INT_TEST_JSON_STRING = "{"
    "\"module\": {"
        "\"targetPriority\": {"
        "}"
    "}"
...
const std::string MODULE_METADATA_NOT_ARRAY_TEST_JSON_STRING = "{"
    "\"module\": {"
        "\"metadata\": \"test\""
    "}"
"}";

const std::string MODULE_PROXY_DATAS_NOT_ARRAY_TEST_JSON_STRING = "{"
    "\"module\": {"
        "\"proxyDatas\": \"test\""
    "}"
"}";

const std::string MODULE_PROXY_DATA_NOT_ARRAY_TEST_JSON_STRING = "{"
    "\"module\": {"
        "\"proxyData\": \"test\""
    "}"
"}";

const std::string MODULE_EXTENSION_ABILITIES_NOT_ARRAY_TEST_JSON_STRING = "{"
    "\"module\": {"
        "\"extensionAbilities\": \"test\""
    "}"
"}";

const std::string MODULE_DEPENDENCIES_NOT_ARRAY_TEST_JSON_STRING = "{"
    "\"module\": {"
        "\"dependencies\": \"test\""
    "}"
"}";

const std::string MODULE_ATOMIC_SERVICE_PRELOADS_NOT_ARRAY_TEST_JSON_STRING = "{"
    "\"module\": {"
        "\"atomicService\": {"
            "\"preloads\": \"test\""
        "}"
...
const std::string MODULE_ABILITY_CONTINUE_TYPE_NOT_ARRAY_TEST_JSON_STRING = "{"
    "\"module\": {"
        "\"abilities\": ["
            "{"
                "\"continueType\": \"test\""
...
/*
 * @tc.name: CheckStageAtomicService_0200
 * @tc.desc: test CheckStageAtomicService
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ModuleJsonTest, CheckStageAtomicService_0200, Function | MediumTest | Level1)
{
    OHOS::AppPackingTool::ModuleJson moduleJson;
    EXPECT_TRUE(moduleJson.ParseFromString(MODULE_ABILITY_NAME_EMPTY_TEST_JSON_STRING));
    EXPECT_FALSE(moduleJson.CheckStageAtomicService());
}

/*
 * @tc.name: CheckStageAtomicService_0300
 * @tc.desc: test CheckStageAtomicService
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ModuleJsonTest, CheckStageAtomicService_0300, Function | MediumTest | Level1)
{
    OHOS::AppPackingTool::ModuleJson moduleJson;
    EXPECT_TRUE(moduleJson.ParseFromString(APP_SHARE_BUNDLE_TYPE_TEST_JSON_STRING));
    EXPECT_FALSE(moduleJson.CheckStageAtomicService());
}

/*
 * @tc.name: CheckStageAtomicService_0400
 * @tc.desc: test CheckStageAtomicService
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ModuleJsonTest, CheckStageAtomicService_0400, Function | MediumTest | Level1)
{
    OHOS::AppPackingTool::ModuleJson moduleJson;
    EXPECT_TRUE(moduleJson.ParseFromString(INSTALLATION_FREE_TEST_JSON_STRING));
    EXPECT_FALSE(moduleJson.CheckStageAtomicService());
}

/*
 * @tc.name: GetModuleNameByModuleObj_0300
 * @tc.desc: test GetModuleNameByModuleObj
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ModuleJsonTest, GetModuleNameByModuleObj_0300, Function | MediumTest | Level1)
{
    ModuleJson moduleJson;
    std::unique_ptr<PtJson> moduleObj;
    std::string moduleName;
    EXPECT_TRUE(moduleJson.ParseFromString(MODULE_NAME_ERROR_TEST_JSON_STRING));
    moduleJson.GetModuleObject(moduleObj);
    EXPECT_FALSE(moduleJson.GetModuleNameByModuleObj(moduleObj, moduleName));
}

/*
 * @tc.name: GetPatchModuleName_0400
 * @tc.desc: test GetPatchModuleName
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ModuleJsonTest, GetPatchModuleName_0400, Function | MediumTest | Level1)
{
    OHOS::AppPackingTool::ModuleJson moduleJson;
    EXPECT_TRUE(moduleJson.ParseFromString(MODULE_NAME_ERROR_TEST_JSON_STRING));
    std::string patchModuleName = "";
 ...
 * @tc.desc: test GetBundleNameByAppObj
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ModuleJsonTest, GetBundleNameByAppObj_0300, Function | MediumTest | Level1)
{
    ModuleJson moduleJson;
    std::unique_ptr<PtJson> appObj;
    std::string bundleName;
    EXPECT_TRUE(moduleJson.ParseFromString(APP_BUNDLE_NAME_ERROR_TEST_JSON_STRING));
    moduleJson.GetModuleObject(appObj);
    EXPECT_FALSE(moduleJson.GetBundleNameByAppObj(appObj, bundleName));
}

/*
 * @tc.name: GetVendorByAppObj_0300
 * @tc.desc: test GetVendorByAppObj
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ModuleJsonTest, GetVendorByAppObj_0300, Function | MediumTest | Level1)
{
    ModuleJson moduleJson;
    std::unique_ptr<PtJson> appObj;
    std::string vendor = "test";
    EXPECT_TRUE(moduleJson.ParseFromString(APP_VENDOR_ERROR_TEST_JSON_STRING));
    moduleJson.GetModuleObject(appObj);
    EXPECT_FALSE(moduleJson.GetVendorByAppObj(appObj, vendor));
}

/*
 * @tc.name: GetTargetBundleNameByAppObj_0200
 * @tc.desc: test GetTargetBundleNameByAppObj
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ModuleJsonTest, GetTargetBundleNameByAppObj_0200, Function | MediumTest | Level1)
{
    ModuleJson moduleJson;
    EXPECT_TRUE(moduleJson.ParseFromString(APP_TARGET_BUNDLE_NAME_ERROR_TEST_JSON_STRING));
    std::unique_ptr<PtJson> appObj;
    std::string targetBundleName = "";
    EXPECT_FALSE(moduleJson.GetTargetBundleNameByAppObj(appObj, targetBundleName));
}
...
/*
 * @tc.name: GetTargetModuleNameByModuleObj_0200
 * @tc.desc: test GetTargetModuleNameByModuleObj
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ModuleJsonTest, GetTargetModuleNameByModuleObj_0200, Function | MediumTest | Level1)
{
    ModuleJson moduleJson;
    EXPECT_TRUE(moduleJson.ParseFromString(MODULE_TARGET_MODULE_NAME_ERROR_TEST_JSON_STRING));
    std::unique_ptr<PtJson> moduleObj;
    std::string targetModuleName;
    EXPECT_FALSE(moduleJson.GetTargetModuleNameByModuleObj(moduleObj, targetModuleName));
}
...
/*
 * @tc.name: GetModuleMetadatasByModuleObj_0700
 * @tc.desc: test GetModuleMetadatasByModuleObj
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ModuleJsonTest, GetModuleMetadatasByModuleObj_0700, Function | MediumTest | Level1)
{
    ModuleJson moduleJson;
    EXPECT_TRUE(moduleJson.ParseFromString(MODULE_METADATA_NAME_ERROR_TEST_JSON_STRING));
    std::unique_ptr<AppPackingTool::PtJson> moduleObj;
    EXPECT_TRUE(moduleJson.GetModuleObject(moduleObj));
    const std::map<std::string, std::string> resourceMap;
    std::list<ModuleMetadataInfo> moduleMetadataInfos;
...
/*
 * @tc.name: GetModuleMetadatasByModuleObj_0800
 * @tc.desc: test GetModuleMetadatasByModuleObj
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ModuleJsonTest, GetModuleMetadatasByModuleObj_0800, Function | MediumTest | Level1)
{
    ModuleJson moduleJson;
    EXPECT_TRUE(moduleJson.ParseFromString(MODULE_METADATA_VALUE_ERROR_TEST_JSON_STRING));
    std::unique_ptr<AppPackingTool::PtJson> moduleObj;
    EXPECT_TRUE(moduleJson.GetModuleObject(moduleObj));
    const std::map<std::string, std::string> resourceMap;
    std::list<ModuleMetadataInfo> moduleMetadataInfos;
...
/*
 * @tc.name: GetModuleMetadatasByModuleObj_0900
 * @tc.desc: test GetModuleMetadatasByModuleObj
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ModuleJsonTest, GetModuleMetadatasByModuleObj_0900, Function | MediumTest | Level1)
{
    ModuleJson moduleJson;
    EXPECT_TRUE(moduleJson.ParseFromString(MODULE_METADATA_RESOURCE_ERROR_TEST_JSON_STRING));
    std::unique_ptr<AppPackingTool::PtJson> moduleObj;
    EXPECT_TRUE(moduleJson.GetModuleObject(moduleObj));
    const std::map<std::string, std::string> resourceMap;
    std::list<ModuleMetadataInfo> moduleMetadataInfos;
...
/*
 * @tc.name: GetAbilityNamesByAbilitiesObj_0300
 * @tc.desc: test GetAbilityNamesByAbilitiesObj
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ModuleJsonTest, GetAbilityNamesByAbilitiesObj_0300, Function | MediumTest | Level1)
{
    ModuleJson moduleJson;
    EXPECT_TRUE(moduleJson.ParseFromString(MODULE_ABILITY_NAME_ERROR_TEST_JSON_STRING));
    std::unique_ptr<PtJson> moduleObj;
    EXPECT_TRUE(moduleJson.GetModuleObject(moduleObj));
    std::list<std::string> abilityNames;
    EXPECT_FALSE(moduleJson.GetAbilityNamesByModuleObj(moduleObj, abilityNames));
...
/*
 * @tc.name: GetProxyDataUrisByProxyDatasObj_0300
 * @tc.desc: test GetProxyDataUrisByProxyDatasObj
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ModuleJsonTest, GetProxyDataUrisByProxyDatasObj_0300, Function | MediumTest | Level1)
{
    ModuleJson moduleJson;
    EXPECT_TRUE(moduleJson.ParseFromString(MODULE_PROXY_URI_ERROR_TEST_JSON_STRING));
    std::unique_ptr<PtJson> moduleObj;
    EXPECT_TRUE(moduleJson.GetModuleObject(moduleObj));
    std::list<std::string> proxyDataUris;
    EXPECT_FALSE(moduleJson.GetProxyDataUrisByModuleObj(moduleObj, proxyDataUris));
...
/*
 * @tc.name: GetExtensionAbilityNamesByExtensionAbilityObj_0200
 * @tc.desc: test GetExtensionAbilityNamesByExtensionAbilityObj
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ModuleJsonTest, GetExtensionAbilityNamesByExtensionAbilityObj_0200, Function | MediumTest | Level1)
{
    OHOS::AppPackingTool::ModuleJson moduleJson;
    EXPECT_TRUE(moduleJson.ParseFromString(MODULE_EXTENSION_ABILITIES_NAME_ERROR_TEST_JSON_STRING));
    std::unique_ptr<PtJson> moduleObj;
    EXPECT_TRUE(moduleJson.GetModuleObject(moduleObj));
    std::list<std::string> extensionAbilityNames;
    EXPECT_FALSE(moduleJson.GetExtensionAbilityNamesByModuleObj(moduleObj, extensionAbilityNames));
...
/*
 * @tc.name: GetDependencyBundleNameByDependencyItemObj_0200
 * @tc.desc: test GetDependencyBundleNameByDependencyItemObj
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ModuleJsonTest, GetDependencyBundleNameByDependencyItemObj_0200, Function | MediumTest | Level1)
{
    OHOS::AppPackingTool::ModuleJson moduleJson;
    EXPECT_TRUE(moduleJson.ParseFromString(MODULE_DEPENDENCIES_BUNDLE_NAME_ERROR_TEST_JSON_STRING));
    std::unique_ptr<AppPackingTool::PtJson> moduleObj;
    EXPECT_TRUE(moduleJson.GetModuleObject(moduleObj));
    std::list<DependencyItem> dependencyItems;
    std::string defaultBundleName = "";
...
/*
 * @tc.name: GetDependencyModuleNameByDependencyItemObj_0200
 * @tc.desc: test GetDependencyModuleNameByDependencyItemObj
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ModuleJsonTest, GetDependencyModuleNameByDependencyItemObj_0200, Function | MediumTest | Level1)
{
    OHOS::AppPackingTool::ModuleJson moduleJson;
    EXPECT_TRUE(moduleJson.ParseFromString(MODULE_DEPENDENCIES_MODULE_NAME_ERROR_TEST_JSON_STRING));
    std::unique_ptr<AppPackingTool::PtJson> moduleObj;
    EXPECT_TRUE(moduleJson.GetModuleObject(moduleObj));
    std::list<DependencyItem> dependencyItems;
    std::string defaultBundleName = "";
...
/*
 * @tc.name: GetAtomicServicePreloadsByModuleObj_0500
 * @tc.desc: test GetAtomicServicePreloadsByModuleObj
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ModuleJsonTest, GetAtomicServicePreloadsByModuleObj_0500, Function | MediumTest | Level1)
{
    OHOS::AppPackingTool::ModuleJson moduleJson;
    EXPECT_TRUE(moduleJson.ParseFromString(MODULE_ATOMIC_SERVICE_PRELOADS_MODULE_NAME_ERROR_TEST_JSON_STRING));
    std::unique_ptr<AppPackingTool::PtJson> moduleObj;
    EXPECT_TRUE(moduleJson.GetModuleObject(moduleObj));
    std::list<PreloadItem> preloadItems;
    EXPECT_TRUE(moduleJson.GetAtomicServicePreloadsByModuleObj(moduleObj, preloadItems));
...
/*
 * @tc.name: GetAbilityNameByAbilityObj_0200
 * @tc.desc: test GetAbilityNameByAbilityObj
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ModuleJsonTest, GetAbilityNameByAbilityObj_0200, Function | MediumTest | Level1)
{
    OHOS::AppPackingTool::ModuleJson moduleJson;
    EXPECT_TRUE(moduleJson.ParseFromString(MODULE_ABILITIES_NAME_ERROR_TEST_JSON_STRING));
    std::unique_ptr<PtJson> moduleObj;
    EXPECT_TRUE(moduleJson.GetModuleObject(moduleObj));
    std::map<std::string, std::list<std::string>> abilityContinueTypeMap;
    EXPECT_FALSE(moduleJson.GetAbilityContinueTypeMapByModuleObj(moduleObj, abilityContinueTypeMap));
...
/*
 * @tc.name: GetContinueTypesByAbilityObj_0200
 * @tc.desc: test GetContinueTypesByAbilityObj
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ModuleJsonTest, GetContinueTypesByAbilityObj_0200, Function | MediumTest | Level1)
{
    OHOS::AppPackingTool::ModuleJson moduleJson;
    EXPECT_TRUE(moduleJson.ParseFromString(MODULE_ABILITIES_CONTINUE_TYPE_ERROR_TEST_JSON_STRING));
    std::unique_ptr<PtJson> moduleObj;
    EXPECT_TRUE(moduleJson.GetModuleObject(moduleObj));
    std::map<std::string, std::list<std::string>> abilityContinueTypeMap;
    EXPECT_FALSE(moduleJson.GetAbilityContinueTypeMapByModuleObj(moduleObj, abilityContinueTypeMap));
...
/*
 * @tc.name: GetMultiAppModeByAppObj_0400
 * @tc.desc: test GetMultiAppModeByAppObj
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ModuleJsonTest, GetMultiAppModeByAppObj_0400, Function | MediumTest | Level1)
{
    OHOS::AppPackingTool::ModuleJson moduleJson;
    EXPECT_TRUE(moduleJson.ParseFromString(APP_MULTI_APP_MODE_TYPE_ERROR_TEST_JSON_STRING));
    std::unique_ptr<PtJson> appObj;
    EXPECT_TRUE(moduleJson.GetAppObject(appObj));
    MultiAppMode multiAppMode;
    EXPECT_FALSE(moduleJson.GetMultiAppModeByAppObj(appObj, multiAppMode));
...
/*
 * @tc.name: GetMultiAppModeByAppObj_0500
 * @tc.desc: test GetMultiAppModeByAppObj
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ModuleJsonTest, GetMultiAppModeByAppObj_0500, Function | MediumTest | Level1)
{
    OHOS::AppPackingTool::ModuleJson moduleJson;
    EXPECT_TRUE(moduleJson.ParseFromString(APP_MULTI_APP_MODE_NUMBER_ERROR_TEST_JSON_STRING));
    std::unique_ptr<PtJson> appObj;
    EXPECT_TRUE(moduleJson.GetAppObject(appObj));
    MultiAppMode multiAppMode;
    EXPECT_FALSE(moduleJson.GetMultiAppModeByAppObj(appObj, multiAppMode));
...
/*
 * @tc.name: IsModuleAtomicServiceValid_0600
 * @tc.desc: test IsModuleAtomicServiceValid
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ModuleJsonTest, IsModuleAtomicServiceValid_0600, Function | MediumTest | Level1)
{
    OHOS::AppPackingTool::ModuleJson moduleJson;
    EXPECT_TRUE(moduleJson.ParseFromString(APP_BUNDLE_TYPE_ERROR_TEST_JSON_STRING));
    EXPECT_FALSE(moduleJson.IsModuleAtomicServiceValid());
}

/*
 * @tc.name: CheckStageOverlayCfg_0200
 * @tc.desc: test CheckStageOverlayCfg
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ModuleJsonTest, CheckStageOverlayCfg_0200, Function | MediumTest | Level1)
{
    OHOS::AppPackingTool::ModuleJson moduleJson;
    EXPECT_TRUE(moduleJson.ParseFromString(MODULE_TARGET_MODULE_NAME_ERROR_TEST_JSON_STRING));
    EXPECT_FALSE(moduleJson.CheckStageOverlayCfg());
}

/*
 * @tc.name: CheckStageOverlayCfg_0300
 * @tc.desc: test CheckStageOverlayCfg
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ModuleJsonTest, CheckStageOverlayCfg_0300, Function | MediumTest | Level1)
{
    OHOS::AppPackingTool::ModuleJson moduleJson;
    EXPECT_TRUE(moduleJson.ParseFromString(MODULE_REQUEST_PERMISSIONS_AND_TARGET_MODULE_NAME_ERROR_TEST_JSON_STRING));
    EXPECT_FALSE(moduleJson.CheckStageOverlayCfg());
}

/*
 * @tc.name: CheckStageOverlayCfg_0400
 * @tc.desc: test CheckStageOverlayCfg
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ModuleJsonTest, CheckStageOverlayCfg_0400, Function | MediumTest | Level1)
{
    OHOS::AppPackingTool::ModuleJson moduleJson;
    EXPECT_TRUE(moduleJson.ParseFromString(MODULE_JSON_TEST_STRING_ERROR));
    EXPECT_FALSE(moduleJson.CheckStageOverlayCfg());
...
/*
 * @tc.name: CheckStageOverlayCfg_0500
 * @tc.desc: test CheckStageOverlayCfg
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ModuleJsonTest, CheckStageOverlayCfg_0500, Function | MediumTest | Level1)
{
    OHOS::AppPackingTool::ModuleJson moduleJson;
    EXPECT_TRUE(moduleJson.ParseFromString(MODULE_TARGET_MODULE_NAME_AND_NAME_SAME_TEST_JSON_STRING));
    EXPECT_FALSE(moduleJson.CheckStageOverlayCfg());
}

/*
 * @tc.name: CheckStageOverlayCfg_0600
 * @tc.desc: test CheckStageOverlayCfg
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ModuleJsonTest, CheckStageOverlayCfg_0600, Function | MediumTest | Level1)
{
    OHOS::AppPackingTool::ModuleJson moduleJson;
    EXPECT_TRUE(moduleJson.ParseFromString(MODULE_TARGET_MODULE_NAME_AND_TARGET_PRIORITY_ERROR_TEST_JSON_STRING));
    EXPECT_FALSE(moduleJson.CheckStageOverlayCfg());
}

/*
 * @tc.name: CheckStageOverlayCfg_0700
 * @tc.desc: test CheckStageOverlayCfg
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ModuleJsonTest, CheckStageOverlayCfg_0700, Function | MediumTest | Level1)
{
    OHOS::AppPackingTool::ModuleJson moduleJson;
    EXPECT_TRUE(moduleJson.ParseFromString(APP_TARGET_BUNDLE_NAME_ERROR_TEST_JSON_STRING));
    EXPECT_FALSE(moduleJson.CheckStageOverlayCfg());
...
/*
 * @tc.name: CheckStageOverlayCfg_0800
 * @tc.desc: test CheckStageOverlayCfg
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ModuleJsonTest, CheckStageOverlayCfg_0800, Function | MediumTest | Level1)
{
    OHOS::AppPackingTool::ModuleJson moduleJson;
    EXPECT_TRUE(moduleJson.ParseFromString(APP_TARGET_BUNDLE_NAME_AND_TARGET_MODULE_NAME_ERROR_TEST_JSON_STRING));
    EXPECT_FALSE(moduleJson.CheckStageOverlayCfg());
}

/*
 * @tc.name: CheckStageOverlayCfg_0900
 * @tc.desc: test CheckStageOverlayCfg
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ModuleJsonTest, CheckStageOverlayCfg_0900, Function | MediumTest | Level1)
{
    OHOS::AppPackingTool::ModuleJson moduleJson;
    EXPECT_TRUE(moduleJson.ParseFromString(APP_BUNDLE_NAME_ERROR_TEST_JSON_STRING));
    EXPECT_FALSE(moduleJson.CheckStageOverlayCfg());
...
/*
 * @tc.name: CheckStageOverlayCfg_1000
 * @tc.desc: test CheckStageOverlayCfg
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ModuleJsonTest, CheckStageOverlayCfg_1000, Function | MediumTest | Level1)
{
    OHOS::AppPackingTool::ModuleJson moduleJson;
    EXPECT_TRUE(moduleJson.ParseFromString(APP_TARGET_BUNDLE_NAME_AND_BUNDLE_NAME_ERROR_TEST_JSON_STRING));
    EXPECT_FALSE(moduleJson.CheckStageOverlayCfg());
}

/*
 * @tc.name: CheckStageOverlayCfg_1100
 * @tc.desc: test CheckStageOverlayCfg
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ModuleJsonTest, CheckStageOverlayCfg_1100, Function | MediumTest | Level1)
{
    OHOS::AppPackingTool::ModuleJson moduleJson;
    EXPECT_TRUE(moduleJson.ParseFromString(APP_TARGET_BUNDLE_NAME_AND_TARGET_PRIORITY_ERROR_TEST_JSON_STRING));
    EXPECT_FALSE(moduleJson.CheckStageOverlayCfg());
}

/*
 * @tc.name: GetGenerateBuildHash_0300
 * @tc.desc: test GetGenerateBuildHash
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ModuleJsonTest, GetGenerateBuildHash_0300, Function | MediumTest | Level1)
{
    OHOS::AppPackingTool::ModuleJson moduleJson;
    EXPECT_TRUE(moduleJson.ParseFromString(APP_VENDOR_ERROR_TEST_JSON_STRING));
    bool generateBuildHash = false;
...
/*
 * @tc.name: GetGenerateBuildHash_0400
 * @tc.desc: test GetGenerateBuildHash
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ModuleJsonTest, GetGenerateBuildHash_0400, Function | MediumTest | Level1)
{
    OHOS::AppPackingTool::ModuleJson moduleJson;
    EXPECT_TRUE(moduleJson.ParseFromString(MODULE_TARGET_MODULE_NAME_ERROR_TEST_JSON_STRING));
    bool generateBuildHash = false;
...
/*
 * @tc.name: GetGenerateBuildHash_0500
 * @tc.desc: test GetGenerateBuildHash
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ModuleJsonTest, GetGenerateBuildHash_0500, Function | MediumTest | Level1)
{
    OHOS::AppPackingTool::ModuleJson moduleJson;
    EXPECT_TRUE(moduleJson.ParseFromString(MODULE_JSON_TEST_STRING_NOTHING));
    bool generateBuildHash = false;
...
/*
 * @tc.name: GetGenerateBuildHash_0600
 * @tc.desc: test GetGenerateBuildHash
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ModuleJsonTest, GetGenerateBuildHash_0600, Function | MediumTest | Level1)
{
    OHOS::AppPackingTool::ModuleJson moduleJson;
...
/*
 * @tc.name: GetGenerateBuildHash_0700
 * @tc.desc: test GetGenerateBuildHash
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ModuleJsonTest, GetGenerateBuildHash_0700, Function | MediumTest | Level1)
{
    OHOS::AppPackingTool::ModuleJson moduleJson;
    EXPECT_TRUE(moduleJson.ParseFromString(MODULE_GENERATE_BUILD_HASH_ERROR_TEST_JSON_STRING));
    bool generateBuildHash = false;
    EXPECT_FALSE(moduleJson.GetGenerateBuildHash(generateBuildHash));
}

/*
 * @tc.name: GetGenerateBuildHash_0800
 * @tc.desc: test GetGenerateBuildHash
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ModuleJsonTest, GetGenerateBuildHash_0800, Function | MediumTest | Level1)
{
    OHOS::AppPackingTool::ModuleJson moduleJson;
    EXPECT_TRUE(moduleJson.ParseFromString(APP_AND_MODULE_EMPTY_TEST_JSON_STRING));
    bool generateBuildHash = false;
    EXPECT_FALSE(moduleJson.GetGenerateBuildHash(generateBuildHash));
}

/*
 * @tc.name: RemoveGenerateBuildHash_0200
 * @tc.desc: test RemoveGenerateBuildHash
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ModuleJsonTest, RemoveGenerateBuildHash_0200, Function | MediumTest | Level1)
{
    OHOS::AppPackingTool::ModuleJson moduleJson;
    EXPECT_TRUE(moduleJson.ParseFromString(APP_GENERATE_BUILD_HASH_ERROR_TEST_JSON_STRING));
    EXPECT_FALSE(moduleJson.RemoveGenerateBuildHash());
}

/*
 * @tc.name: RemoveGenerateBuildHash_0300
 * @tc.desc: test RemoveGenerateBuildHash
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ModuleJsonTest, RemoveGenerateBuildHash_0300, Function | MediumTest | Level1)
{
    OHOS::AppPackingTool::ModuleJson moduleJson;
    EXPECT_TRUE(moduleJson.ParseFromString(MODULE_GENERATE_BUILD_HASH_ERROR_TEST_JSON_STRING));
    EXPECT_FALSE(moduleJson.RemoveGenerateBuildHash());
...
/*
 * @tc.name: RemoveGenerateBuildHash_0400
 * @tc.desc: test RemoveGenerateBuildHash
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ModuleJsonTest, RemoveGenerateBuildHash_0400, Function | MediumTest | Level1)
{
    OHOS::AppPackingTool::ModuleJson moduleJson;
    EXPECT_FALSE(moduleJson.RemoveGenerateBuildHash());
}
...
/*
 * @tc.name: RemoveGenerateBuildHashFromAppObj_0200
 * @tc.desc: test RemoveGenerateBuildHashFromAppObj
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ModuleJsonTest, RemoveGenerateBuildHashFromAppObj_0200, Function | MediumTest | Level1)
{
    OHOS::AppPackingTool::ModuleJson moduleJson;
    EXPECT_TRUE(moduleJson.ParseFromString(APP_AND_MODULE_EMPTY_TEST_JSON_STRING));
    EXPECT_TRUE(moduleJson.RemoveGenerateBuildHashFromAppObj());
...
/*
 * @tc.name: RemoveGenerateBuildHashFromModuleObj_0200
 * @tc.desc: test RemoveGenerateBuildHashFromModuleObj
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ModuleJsonTest, RemoveGenerateBuildHashFromModuleObj_0200, Function | MediumTest | Level1)
{
    OHOS::AppPackingTool::ModuleJson moduleJson;
    EXPECT_TRUE(moduleJson.ParseFromString(APP_AND_MODULE_EMPTY_TEST_JSON_STRING));
    EXPECT_TRUE(moduleJson.RemoveGenerateBuildHashFromModuleObj());
...
/*
 * @tc.name: GetNormalizeVersion_0300
 * @tc.desc: test GetNormalizeVersion
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ModuleJsonTest, GetNormalizeVersion_0300, Function | MediumTest | Level1)
{
    OHOS::AppPackingTool::ModuleJson moduleJson;
    EXPECT_TRUE(moduleJson.ParseFromString(MODULE_GENERATE_BUILD_HASH_ERROR_TEST_JSON_STRING));
    NormalizeVersion normalizeVersion;
...
/*
 * @tc.name: GetNormalizeVersion_0400
 * @tc.desc: test GetNormalizeVersion
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ModuleJsonTest, GetNormalizeVersion_0400, Function | MediumTest | Level1)
{
    OHOS::AppPackingTool::ModuleJson moduleJson;
    EXPECT_TRUE(moduleJson.ParseFromString(MODULE_GENERATE_BUILD_HASH_ERROR_TEST_JSON_STRING));
    NormalizeVersion normalizeVersion;
...
/*
 * @tc.name: GetNormalizeVersion_0500
 * @tc.desc: test GetNormalizeVersion
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ModuleJsonTest, GetNormalizeVersion_0500, Function | MediumTest | Level1)
{
    OHOS::AppPackingTool::ModuleJson moduleJson;
    EXPECT_TRUE(moduleJson.ParseFromString(MODULE_NAME_ERROR_TEST_JSON_STRING));
    NormalizeVersion normalizeVersion;
...
/*
 * @tc.name: SetVersionCodeAndName_0300
 * @tc.desc: test SetVersionCodeAndName
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ModuleJsonTest, SetVersionCodeAndName_0300, Function | MediumTest | Level1)
{
    OHOS::AppPackingTool::ModuleJson moduleJson;
    EXPECT_TRUE(moduleJson.ParseFromString(APP_AND_MODULE_EMPTY_TEST_JSON_STRING));
    int32_t versionCode = 8;
    std::string versionName = "2.2.2";
    bool isStage = true;
    EXPECT_FALSE(moduleJson.SetVersionCodeAndName(versionCode, versionName, isStage));
}

/*
 * @tc.name: SetVersionCodeAndName_0400
 * @tc.desc: test SetVersionCodeAndName
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ModuleJsonTest, SetVersionCodeAndName_0400, Function | MediumTest | Level1)
{
    OHOS::AppPackingTool::ModuleJson moduleJson;
    EXPECT_TRUE(moduleJson.ParseFromString(APP_AND_MODULE_EMPTY_TEST_JSON_STRING));
    int32_t versionCode = 8;
...
/*
 * @tc.name: SetBuildHash_0200
 * @tc.desc: test SetBuildHash
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ModuleJsonTest, SetBuildHash_0200, Function | MediumTest | Level1)
{
    OHOS::AppPackingTool::ModuleJson moduleJson;
    EXPECT_TRUE(moduleJson.ParseFromString(APP_GENERATE_BUILD_HASH_ERROR_TEST_JSON_STRING));
...
/*
 * @tc.name: GetFaVersionByVersionObj_0400
 * @tc.desc: test GetFaVersionByVersionObj
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ModuleJsonTest, GetFaVersionByVersionObj_0400, Function | MediumTest | Level1)
{
    OHOS::AppPackingTool::ModuleJson moduleJson;
    EXPECT_TRUE(moduleJson.ParseFromString(MODULE_JSON_TEST_VERCODE_NOTINT_STRING));
    std::unique_ptr<PtJson> appObj;
    EXPECT_TRUE(moduleJson.GetAppObject(appObj));
    Version version;
...
/*
 * @tc.name: GetFaVersionByVersionObj_0500
 * @tc.desc: test GetFaVersionByVersionObj
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ModuleJsonTest, GetFaVersionByVersionObj_0500, Function | MediumTest | Level1)
{
    OHOS::AppPackingTool::ModuleJson moduleJson;
    EXPECT_TRUE(moduleJson.ParseFromString(MODULE_JSON_TEST_VERNAME_NOTSTRING_STRING));
    std::unique_ptr<PtJson> appObj;
    EXPECT_TRUE(moduleJson.GetAppObject(appObj));
    Version version;
    EXPECT_FALSE(moduleJson.GetFaVersionByAppObj(appObj, version));
...
/*
 * @tc.name: GetFaVersionByVersionObj_0600
 * @tc.desc: test GetFaVersionByVersionObj
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ModuleJsonTest, GetFaVersionByVersionObj_0600, Function | MediumTest | Level1)
{
    OHOS::AppPackingTool::ModuleJson moduleJson;
    EXPECT_TRUE(moduleJson.ParseFromString(MODULE_JSON_TEST_VERMINCOMPATIBLEVERSIONCODE_NOTINT_STRING));
    std::unique_ptr<PtJson> appObj;
    EXPECT_TRUE(moduleJson.GetAppObject(appObj));
    Version version;
    EXPECT_FALSE(moduleJson.GetFaVersionByAppObj(appObj, version));
...
/*
 * @tc.name: SetFaVersionCode_0300
 * @tc.desc: test set fa version code
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ModuleJsonTest, SetFaVersionCode_0300, Function | MediumTest | Level1)
{
    OHOS::AppPackingTool::ModuleJson moduleJson;
    EXPECT_TRUE(moduleJson.ParseFromString(MODULE_JSON_TEST_NOT_VERCODE_STRING));
    int32_t versionCode = 9;
    EXPECT_FALSE(moduleJson.SetFaVersionCode(versionCode));
}

/*
 * @tc.name: SetFaVersionName_0300
 * @tc.desc: test set fa version name
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ModuleJsonTest, SetFaVersionName_0300, Function | MediumTest | Level1)
{
    OHOS::AppPackingTool::ModuleJson moduleJson;
    EXPECT_TRUE(moduleJson.ParseFromString(MODULE_JSON_TEST_NOTVERNAME_STRING));
    std::string versionName = "1.1.1";
    EXPECT_FALSE(moduleJson.SetFaVersionName(versionName));
}

/*
 * @tc.name: GetFaInstallationFreeByDistroObj_0200
 * @tc.desc: test GetFaInstallationFreeByDistroObj
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ModuleJsonTest, GetFaInstallationFreeByDistroObj_0200, Function | MediumTest | Level1)
{
    OHOS::AppPackingTool::ModuleJson moduleJson;
    EXPECT_TRUE(moduleJson.ParseFromString(MODULE_JSON_TEST_DISINSTALLATIONFREE_NOTBOOL_STRING));
    std::unique_ptr<PtJson> distroObj;
    EXPECT_TRUE(moduleJson.GetDistroObject(distroObj));
    bool installationFree = true;
    EXPECT_FALSE(moduleJson.GetFaInstallationFreeByDistroObj(distroObj, installationFree));
}

/*
 * @tc.name: GetFaBundleType_0300
 * @tc.desc: test get fa bundle type
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ModuleJsonTest, GetFaBundleType_0300, Function | MediumTest | Level1)
{
    OHOS::AppPackingTool::ModuleJson moduleJson;
    EXPECT_TRUE(moduleJson.ParseFromString(MODULE_JSON_TEST_DISINSTALLATIONFREE_ISTRUE_STRING));
    std::string bundleType = "";
    EXPECT_TRUE(moduleJson.GetFaBundleType(bundleType));
    EXPECT_STREQ(bundleType.c_str(), "atomicService");
}
...
/*
 * @tc.name: GetFaModuleApiVersionByApiVersionObj_0200
 * @tc.desc: test GetFaModuleApiVersionByApiVersionObj
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ModuleJsonTest, GetFaModuleApiVersionByApiVersionObj_0200, Function | MediumTest | Level1)
{
    OHOS::AppPackingTool::ModuleJson moduleJson;
    EXPECT_TRUE(moduleJson.ParseFromString(MODULE_JSON_APICOMPATIBLE_NOTINT_STRING));
    std::unique_ptr<PtJson> appObj;
    EXPECT_TRUE(moduleJson.GetAppObject(appObj));
    ModuleApiVersion moduleApiVersion;
...
/*
 * @tc.name: GetFaModuleApiVersionByApiVersionObj_0300
 * @tc.desc: test GetFaModuleApiVersionByApiVersionObj
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ModuleJsonTest, GetFaModuleApiVersionByApiVersionObj_0300, Function | MediumTest | Level1)
{
    OHOS::AppPackingTool::ModuleJson moduleJson;
    EXPECT_TRUE(moduleJson.ParseFromString(MODULE_JSON_APITARGET_NOTINT_STRING));
    std::unique_ptr<PtJson> appObj;
    EXPECT_TRUE(moduleJson.GetAppObject(appObj));
    ModuleApiVersion moduleApiVersion;
    EXPECT_FALSE(moduleJson.GetFaModuleApiVersionByAppObj(appObj, moduleApiVersion));
...
/*
 * @tc.name: GetFaModuleApiVersionByApiVersionObj_0400
 * @tc.desc: test GetFaModuleApiVersionByApiVersionObj
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ModuleJsonTest, GetFaModuleApiVersionByApiVersionObj_0400, Function | MediumTest | Level1)
{
    OHOS::AppPackingTool::ModuleJson moduleJson;
    EXPECT_TRUE(moduleJson.ParseFromString(MODULE_JSON_APIRELEASETYPE_NOTSTRING_STRING));
    std::unique_ptr<PtJson> appObj;
    EXPECT_TRUE(moduleJson.GetAppObject(appObj));
    ModuleApiVersion moduleApiVersion;
    EXPECT_FALSE(moduleJson.GetFaModuleApiVersionByAppObj(appObj, moduleApiVersion));
...
/*
 * @tc.name: GetFaModuleName_0300
 * @tc.desc: test get fa module name
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ModuleJsonTest, GetFaModuleName_0300, Function | MediumTest | Level1)
{
    OHOS::AppPackingTool::ModuleJson moduleJson;
    EXPECT_TRUE(moduleJson.ParseFromString(MODULE_JSON_EMPTY_APP_AND_MODULE_STRING));
    std::string faModuleName = "";
    EXPECT_FALSE(moduleJson.GetFaModuleName(faModuleName));
}

/*
 * @tc.name: GetFaModuleName_0400
 * @tc.desc: test get fa module name
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ModuleJsonTest, GetFaModuleName_0400, Function | MediumTest | Level1)
{
    OHOS::AppPackingTool::ModuleJson moduleJson;
    EXPECT_TRUE(moduleJson.ParseFromString(MODULE_JSON_NOT_DISMODULENAME_STRING));
    std::string faModuleName = "";
    EXPECT_FALSE(moduleJson.GetFaModuleName(faModuleName));
}

/*
 * @tc.name: GetFaModuleName_0500
 * @tc.desc: test get fa module name
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ModuleJsonTest, GetFaModuleName_0500, Function | MediumTest | Level1)
{
    OHOS::AppPackingTool::ModuleJson moduleJson;
    EXPECT_TRUE(moduleJson.ParseFromString(MODULE_JSON_DISMODULENAME_NOTSTRING_STRING));
    std::string faModuleName = "";
    EXPECT_FALSE(moduleJson.GetFaModuleName(faModuleName));
}

/*
 * @tc.name: GetFaModuleNameByDistroObj_0300
 * @tc.desc: test GetFaModuleNameByDistroObj
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ModuleJsonTest, GetFaModuleNameByDistroObj_0300, Function | MediumTest | Level1)
{
    OHOS::AppPackingTool::ModuleJson moduleJson;
    EXPECT_TRUE(moduleJson.ParseFromString(MODULE_JSON_DISMODULENAME_NOTSTRING_STRING));
    std::unique_ptr<PtJson> moduleObj;
...
/*
 * @tc.name: GetFaPackageStrByModuleObj_0300
 * @tc.desc: test GetFaPackageStrByModuleObj
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ModuleJsonTest, GetFaPackageStrByModuleObj_0300, Function | MediumTest | Level1)
{
    OHOS::AppPackingTool::ModuleJson moduleJson;
    EXPECT_TRUE(moduleJson.ParseFromString(MODULE_JSON_MOUPACKAGE_NOTSTRING_STRING));
    std::unique_ptr<PtJson> moduleObj;
    EXPECT_TRUE(moduleJson.GetModuleObject(moduleObj));
    std::string packageStr = "";
    EXPECT_FALSE(moduleJson.GetFaPackageStrByModuleObj(moduleObj, packageStr));
...
/*
 * @tc.name: GetFaCompileSdkTypeByAppObj_0300
 * @tc.desc: test GetFaCompileSdkTypeByAppObj
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ModuleJsonTest, GetFaCompileSdkTypeByAppObj_0300, Function | MediumTest | Level1)
{
    OHOS::AppPackingTool::ModuleJson moduleJson;
    EXPECT_TRUE(moduleJson.ParseFromString(MODULE_JSON_APICOMPILESDKTYPE_NOTSTRING_STRING));
    std::unique_ptr<PtJson> appObj;
    EXPECT_TRUE(moduleJson.GetAppObject(appObj));
    std::string compileSdkType = "";
...
/*
 * @tc.name: GetFaCompileSdkVersionByAppObj_0300
 * @tc.desc: test GetFaCompileSdkVersionByAppObj
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ModuleJsonTest, GetFaCompileSdkVersionByAppObj_0300, Function | MediumTest | Level1)
{
    OHOS::AppPackingTool::ModuleJson moduleJson;
    EXPECT_TRUE(moduleJson.ParseFromString(MODULE_JSON_APICOMPILESDKVERSION_NOTSTRING_STRING));
    std::unique_ptr<PtJson> appObj;
    EXPECT_TRUE(moduleJson.GetAppObject(appObj));
    std::string compileSdkVersion = "";
...
/*
 * @tc.name: GetFaDebugByDeviceConfigObj_0300
 * @tc.desc: test GetFaDebugByDeviceConfigObj
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ModuleJsonTest, GetFaDebugByDeviceConfigObj_0300, Function | MediumTest | Level1)
{
    OHOS::AppPackingTool::ModuleJson moduleJson;
    EXPECT_TRUE(moduleJson.ParseFromString(MODULE_JSON_DEVDEBUG_NOTBOOL_STRING));
    std::unique_ptr<PtJson> deviceConfigObj;
    EXPECT_TRUE(moduleJson.GetDeviceConfigObject(deviceConfigObj));
    bool debug = false;
    EXPECT_FALSE(moduleJson.GetFaDebugByDeviceConfigObj(deviceConfigObj, debug));
}

/*
 * @tc.name: GetFaEntry_0300
 * @tc.desc: test get fa entry
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ModuleJsonTest, GetFaEntry_0300, Function | MediumTest | Level1)
{
    OHOS::AppPackingTool::ModuleJson moduleJson;
    EXPECT_TRUE(moduleJson.ParseFromString(MODULE_JSON_EMPTY_APP_AND_MODULE_STRING));
    std::list<std::string> deviceTypes;
...
/*
 * @tc.name: GetFaEntry_0400
 * @tc.desc: test get fa entry
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ModuleJsonTest, GetFaEntry_0400, Function | MediumTest | Level1)
{
    OHOS::AppPackingTool::ModuleJson moduleJson;
    EXPECT_TRUE(moduleJson.ParseFromString(MODULE_JSON_TEST_NOT_DISMODULETYPE_STRING));
    std::list<std::string> deviceTypes;
    EXPECT_FALSE(moduleJson.GetFaEntry(deviceTypes));
}

/*
 * @tc.name: GetFaEntry_0500
 * @tc.desc: test get fa entry
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ModuleJsonTest, GetFaEntry_0500, Function | MediumTest | Level1)
{
    OHOS::AppPackingTool::ModuleJson moduleJson;
    EXPECT_TRUE(moduleJson.ParseFromString(MODULE_JSON_TEST_DISMODULETYPE_NOTSTRING_STRING));
    std::list<std::string> deviceTypes;
    EXPECT_FALSE(moduleJson.GetFaEntry(deviceTypes));
}

/*
 * @tc.name: GetFaDeviceTypesByModuleObj_0300
 * @tc.desc: test GetFaDeviceTypesByModuleObj
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ModuleJsonTest, GetFaDeviceTypesByModuleObj_0300, Function | MediumTest | Level1)
{
    OHOS::AppPackingTool::ModuleJson moduleJson;
    EXPECT_TRUE(moduleJson.ParseFromString(MODULE_JSON_MODDEVICETYPE_NOTARRAY_STRING));
    std::unique_ptr<PtJson> moduleObj;
    EXPECT_TRUE(moduleJson.GetModuleObject(moduleObj));
    std::list<std::string> deviceTypes;
    EXPECT_FALSE(moduleJson.GetFaDeviceTypesByModuleObj(moduleObj, deviceTypes));
...
/*
 * @tc.name: GetFaModuleTypeByModuleObj_0200
 * @tc.desc: test GetFaModuleTypeByModuleObj
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ModuleJsonTest, GetFaModuleTypeByModuleObj_0200, Function | MediumTest | Level1)
{
    OHOS::AppPackingTool::ModuleJson moduleJson;
    EXPECT_TRUE(moduleJson.ParseFromString(MODULE_JSON_TEST_DISMODULETYPE_NOTSTRING_STRING));
    std::unique_ptr<PtJson> moduleObj;
...
/*
 * @tc.name: GetFaReleaseTypeByAppObj_0200
 * @tc.desc: test GetFaReleaseTypeByAppObj
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ModuleJsonTest, GetFaReleaseTypeByAppObj_0200, Function | MediumTest | Level1)
{
    OHOS::AppPackingTool::ModuleJson moduleJson;
    EXPECT_TRUE(moduleJson.ParseFromString(MODULE_JSON_APIRELEASETYPE_NOTSTRING_STRING));
    std::unique_ptr<PtJson> appObj;
...
/*
 * @tc.name: GetFaAsanEnabledByAppObj_0300
 * @tc.desc: test GetFaAsanEnabledByAppObj
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ModuleJsonTest, GetFaAsanEnabledByAppObj_0300, Function | MediumTest | Level1)
{
    OHOS::AppPackingTool::ModuleJson moduleJson;
    EXPECT_TRUE(moduleJson.ParseFromString(MODULE_JSON_APPASANENBALED_NOTBOOL_STRING));
    std::unique_ptr<PtJson> appObj;
    EXPECT_TRUE(moduleJson.GetAppObject(appObj));
    bool asanEnabled = true;
    EXPECT_FALSE(moduleJson.GetFaAsanEnabledByAppObj(appObj, asanEnabled));
}

/*
 * @tc.name: GetAppObject_0400
 * @tc.desc: test GetAppObject
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ModuleJsonTest, GetAppObject_0400, Function | MediumTest | Level1)
{
    OHOS::AppPackingTool::ModuleJson moduleJson;
    std::unique_ptr<AppPackingTool::PtJson> appObj;
    moduleJson.ParseFromString(APP_NOT_OBJECT_TEST_JSON_STRING);
    EXPECT_FALSE(moduleJson.GetAppObject(appObj));
}

/*
 * @tc.name: GetDeviceConfigObjectt_0400
 * @tc.desc: test GetDeviceConfigObject
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ModuleJsonTest, GetDeviceConfigObjectt_0400, Function | MediumTest | Level1)
{
    OHOS::AppPackingTool::ModuleJson moduleJson;
    std::unique_ptr<AppPackingTool::PtJson> deviceConfigObj;
    moduleJson.ParseFromString(DEVICE_CONFIG_NOT_OBJECT_TEST_JSON_STRING);
    EXPECT_FALSE(moduleJson.GetDeviceConfigObject(deviceConfigObj));
}

/*
 * @tc.name: GetVersionObject_0400
 * @tc.desc: test GetVersionObject
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ModuleJsonTest, GetVersionObject_0400, Function | MediumTest | Level1)
{
    OHOS::AppPackingTool::ModuleJson moduleJson;
...
/*
 * @tc.name: GetModuleObject_0400
 * @tc.desc: test GetModuleObject
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ModuleJsonTest, GetModuleObject_0400, Function | MediumTest | Level1)
{
    ModuleJson moduleJson;
    EXPECT_TRUE(moduleJson.ParseFromString(MODULE_NOT_OBJECT_TEST_JSON_STRING));
    std::unique_ptr<PtJson> moduleObj;
    EXPECT_FALSE(moduleJson.GetModuleObject(moduleObj));
}
 ...
 * @tc.desc: test GetDistroObjectByModuleObj
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ModuleJsonTest, GetDistroObjectByModuleObj_0300, Function | MediumTest | Level1)
{
    ModuleJson moduleJson;
    std::unique_ptr<PtJson> moduleObj;
    std::unique_ptr<PtJson> distroObj;
...
/*
 * @tc.name: GetApiVersionObject_0400
 * @tc.desc: test GetApiVersionObject
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ModuleJsonTest, GetApiVersionObject_0400, Function | MediumTest | Level1)
{
    OHOS::AppPackingTool::ModuleJson moduleJson;
...
/*
 * @tc.name: GetTargetPriorityByAppObj_0200
 * @tc.desc: test GetTargetPriorityByAppObj
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ModuleJsonTest, GetTargetPriorityByAppObj_0200, Function | MediumTest | Level1)
{
    ModuleJson moduleJson;
    EXPECT_TRUE(moduleJson.ParseFromString(APP_TARGET_PRIORITY_NOT_INT_TEST_JSON_STRING));
    std::unique_ptr<PtJson> appObj;
    EXPECT_TRUE(moduleJson.GetAppObject(appObj));
    int32_t targetPriority = -1;
    EXPECT_FALSE(moduleJson.GetTargetPriorityByAppObj(appObj, targetPriority));
...
/*
 * @tc.name: GetTargetModulePriorityByModuleObj_0200
 * @tc.desc: test GetTargetModulePriorityByModuleObj
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ModuleJsonTest, GetTargetModulePriorityByModuleObj_0200, Function | MediumTest | Level1)
{
    ModuleJson moduleJson;
    EXPECT_TRUE(moduleJson.ParseFromString(MODULE_TARGET_PRIORITY_NOT_INT_TEST_JSON_STRING));
    std::unique_ptr<PtJson> moduleObj;
    EXPECT_TRUE(moduleJson.GetModuleObject(moduleObj));
    int32_t targetModulePriority = -1;
    EXPECT_FALSE(moduleJson.GetTargetModulePriorityByModuleObj(moduleObj, targetModulePriority));
...
/*
 * @tc.name: ParseModuleMetadatasToDistroFilter_0300
 * @tc.desc: test ParseModuleMetadatasToDistroFilter
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ModuleJsonTest, ParseModuleMetadatasToDistroFilter_0300, Function | MediumTest | Level1)
{
    ModuleJson moduleJson;
    std::list<ModuleMetadataInfo> moduleMetadataInfos;
    ModuleMetadataInfo metadataInfo;
    metadataInfo.resource = "{"
                            "\"distributionFilter\": \"test\""
                            "}";
    moduleMetadataInfos.push_back(metadataInfo);
    DistroFilter distroFilter;
    EXPECT_FALSE(moduleJson.ParseModuleMetadatasToDistroFilter(moduleMetadataInfos, distroFilter));
...
/*
 * @tc.name: ParseModuleMetadatasToDistroFilter_0400
 * @tc.desc: test ParseModuleMetadatasToDistroFilter
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ModuleJsonTest, ParseModuleMetadatasToDistroFilter_0400, Function | MediumTest | Level1)
{
    ModuleJson moduleJson;
    std::list<ModuleMetadataInfo> moduleMetadataInfos;
    ModuleMetadataInfo metadataInfo;
...
/*
 * @tc.name: ParseModuleMetadatasToDistroFilter_0500
 * @tc.desc: test ParseModuleMetadatasToDistroFilter
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ModuleJsonTest, ParseModuleMetadatasToDistroFilter_0500, Function | MediumTest | Level1)
{
    ModuleJson moduleJson;
    std::list<ModuleMetadataInfo> moduleMetadataInfos;
    ModuleMetadataInfo metadataInfo;
 ...
 * @tc.require:
 */
HWTEST_F(ModuleJsonTest, GetAbilityNamesByModuleObj_0200, Function | MediumTest | Level1)
{
    ModuleJson moduleJson;
...
/*
 * @tc.name: GetModuleMetadatasByModuleObj_1000
 * @tc.desc: test GetModuleMetadatasByModuleObj
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ModuleJsonTest, GetModuleMetadatasByModuleObj_1000, Function | MediumTest | Level1)
{
    OHOS::AppPackingTool::ModuleJson moduleJson;
    EXPECT_TRUE(moduleJson.ParseFromString(MODULE_METADATA_NOT_ARRAY_TEST_JSON_STRING));
    std::unique_ptr<AppPackingTool::PtJson> moduleObj;
    EXPECT_TRUE(moduleJson.GetModuleObject(moduleObj));
    map<std::string, std::string> resourceMap;
    std::list<ModuleMetadataInfo> moduleMetadataInfos;
...
/*
 * @tc.name: GetProxyDataUrisByModuleObj_0200
 * @tc.desc: test GetProxyDataUrisByModuleObj
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ModuleJsonTest, GetProxyDataUrisByModuleObj_0200, Function | MediumTest | Level1)
{
    ModuleJson moduleJson;
    EXPECT_TRUE(moduleJson.ParseFromString(MODULE_PROXY_DATAS_NOT_ARRAY_TEST_JSON_STRING));
    std::unique_ptr<AppPackingTool::PtJson> moduleObj;
    EXPECT_TRUE(moduleJson.GetModuleObject(moduleObj));
    std::list<std::string> proxyDataUris;
    EXPECT_FALSE(moduleJson.GetProxyDataUrisByModuleObj(moduleObj, proxyDataUris));
...
/*
 * @tc.name: GetProxyDataUrisByModuleObj_0300
 * @tc.desc: test GetProxyDataUrisByModuleObj
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ModuleJsonTest, GetProxyDataUrisByModuleObj_0300, Function | MediumTest | Level1)
{
    ModuleJson moduleJson;
    EXPECT_TRUE(moduleJson.ParseFromString(MODULE_PROXY_DATA_NOT_ARRAY_TEST_JSON_STRING));
    std::unique_ptr<AppPackingTool::PtJson> moduleObj;
    EXPECT_TRUE(moduleJson.GetModuleObject(moduleObj));
    std::list<std::string> proxyDataUris;
    EXPECT_FALSE(moduleJson.GetProxyDataUrisByModuleObj(moduleObj, proxyDataUris));
...
/*
 * @tc.name: GetExtensionAbilityNamesByModuleObj_0400
 * @tc.desc: test GetExtensionAbilityNamesByModuleObj
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ModuleJsonTest, GetExtensionAbilityNamesByModuleObj_0400, Function | MediumTest | Level1)
{
    OHOS::AppPackingTool::ModuleJson moduleJson;
    EXPECT_TRUE(moduleJson.ParseFromString(MODULE_EXTENSION_ABILITIES_NOT_ARRAY_TEST_JSON_STRING));
    std::unique_ptr<AppPackingTool::PtJson> moduleObj;
    EXPECT_TRUE(moduleJson.GetModuleObject(moduleObj));
    std::list<std::string> extensionAbilityNames;
    EXPECT_FALSE(moduleJson.GetExtensionAbilityNamesByModuleObj(moduleObj, extensionAbilityNames));
...
/*
 * @tc.name: GetDependencyItemsByModuleObj_0500
 * @tc.desc: test GetDependencyItemsByModuleObj
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ModuleJsonTest, GetDependencyItemsByModuleObj_0500, Function | MediumTest | Level1)
{
    OHOS::AppPackingTool::ModuleJson moduleJson;
    EXPECT_TRUE(moduleJson.ParseFromString(MODULE_DEPENDENCIES_NOT_ARRAY_TEST_JSON_STRING));
    std::unique_ptr<AppPackingTool::PtJson> moduleObj;
    EXPECT_TRUE(moduleJson.GetModuleObject(moduleObj));
    std::list<DependencyItem> dependencyItems;
    std::string defaultBundleName = "";
...
/*
 * @tc.name: GetAtomicServicePreloadsByModuleObj_0600
 * @tc.desc: test GetAtomicServicePreloadsByModuleObj
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ModuleJsonTest, GetAtomicServicePreloadsByModuleObj_0600, Function | MediumTest | Level1)
{
    OHOS::AppPackingTool::ModuleJson moduleJson;
    EXPECT_TRUE(moduleJson.ParseFromString(MODULE_ATOMIC_SERVICE_PRELOADS_NOT_ARRAY_TEST_JSON_STRING));
    std::unique_ptr<AppPackingTool::PtJson> moduleObj;
    EXPECT_TRUE(moduleJson.GetModuleObject(moduleObj));
    std::list<PreloadItem> preloadItems;
    EXPECT_FALSE(moduleJson.GetAtomicServicePreloadsByModuleObj(moduleObj, preloadItems));
...
/*
 * @tc.name: GetContinueTypesByAbilityObj_0300
 * @tc.desc: test GetContinueTypesByAbilityObj
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ModuleJsonTest, GetContinueTypesByAbilityObj_0300, Function | MediumTest | Level1)
{
    OHOS::AppPackingTool::ModuleJson moduleJson;
    EXPECT_TRUE(moduleJson.ParseFromString(MODULE_ABILITY_CONTINUE_TYPE_NOT_ARRAY_TEST_JSON_STRING));
    std::unique_ptr<PtJson> moduleObj;
    EXPECT_TRUE(moduleJson.GetModuleObject(moduleObj));
    std::map<std::string, std::list<std::string>> abilityContinueTypeMap;
    EXPECT_FALSE(moduleJson.GetAbilityContinueTypeMapByModuleObj(moduleObj, abilityContinueTypeMap));
...
/*
 * @tc.name: GetAbilityContinueTypeMapByModuleObj_0300
 * @tc.desc: test GetAbilityContinueTypeMapByModuleObj
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ModuleJsonTest, GetAbilityContinueTypeMapByModuleObj_0300, Function | MediumTest | Level1)
{
    OHOS::AppPackingTool::ModuleJson moduleJson;
    EXPECT_TRUE(moduleJson.ParseFromString(MODULE_ABILITIES_NOT_ARRAY_TEST_JSON_STRING));
    std::unique_ptr<PtJson> moduleObj;
